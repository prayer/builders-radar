...
- compact detail-page header layout:
  - full-width title row without desktop ellipsis truncation
  - smaller title scale for denser first-screen reading
  - summary-left / `Source Stats`-right desktop meta row
